 ...
 *
 * The Fluid partial renders a hidden input named like
 * `tx_form_formframework[form-1][field-id]` plus optional `<altcha-widget>`.
 * The verified payload is synced into that hidden input for form submission.
 */
